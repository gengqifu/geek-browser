...
public class Constants {
	...
	public static final String PREFERENCES_START_PAGE_SHOW_WEATHER = "StartPageEnableWeather";
	public static final String PREFERENCES_START_PAGE_SHOW_NAVIGATION = "StratPageEnableNavigation";
